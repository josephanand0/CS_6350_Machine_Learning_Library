...
def train_sgd(X_train, y_train, input_size, hidden_layer_size, output_size, gamma_0, d, epochs):
...
for width in hidden_size:
    W1, b1, W2, b2, W3, b3 = train_sgd(X_train, y_train, input_size, width, output_size, gamma_0, d, epochs)
