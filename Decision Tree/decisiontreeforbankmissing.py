...
def handle_missing_values(X_train, X_test):
    for col in X_train.columns:
        ...
        X_train[col] = X_train[col].replace('unknown', most_common)  
        X_test[col] = X_test[col].replace('unknown', most_common)  
...
train_data, test_data = load_data('datasets/bank/train.csv', 'datasets/bank/test.csv')
